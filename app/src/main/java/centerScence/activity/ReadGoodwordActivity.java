...
import centerScence.presenter.Good_Word_getContent_Post;
...
public class ReadGoodwordActivity extends AppCompatActivity {
    ...
    void getData() {
        ...
        Good_Word_getContent_Post good_word_getContent_post = new Good_Word_getContent_Post();
        good_word_getContent_post.Post(id);
    }
    ...
    public void messageEventBus(EventGoodwordContent event) {
        texts = event.contents;
        initData();
    }
}
