...
public class Home_getGrilBook_Post {
    ...
    public void Post(String type) {
        ...
        login_call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                EventBus.getDefault().post(new EventGrilBookBeans(new ArrayList<BookBean>()));
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                EventBus.getDefault().post(new EventGrilBookBeans(bookShelfBeens));
            }
        });
    }
}
